...
function IconMic({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 14a3.99 3.99 0 0 0 3.99-4V6a3.99 3.99 0 0 0-7.98 0v4a3.99 3.99 0 0 0 3.99 4zm6.8-4a.8.8 0 0 0-1.6 0 5.6 5.6 0 0 1-11.2 0 .8.8 0 1 0-1.6 0A7.2 7.2 0 0 0 12 16.2V18h-2a.8.8 0 0 0 0 1.6h8a.8.8 0 1 0 0-1.6h-2v-1.8A7.2 7.2 0 0 0 18.8 10z" />
    </svg>
  );
}
